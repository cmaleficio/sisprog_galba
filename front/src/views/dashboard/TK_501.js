...
const socket = io('http://10.168.161.18:3300')
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const response = await axios.get('http://10.168.161.18:3300/tk501')
    ...
    <>
      ...
      {loaded && sisprogData.length > 0 && (
        <CRow>
          <CCol>
            <CCard>
              <h2>Facilidades de PRODUCCIÓN CAMPO TEMBLADOR | CRUDO TK-501 | TK-502</h2>
