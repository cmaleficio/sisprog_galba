    ...
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>PLANTAS OPERATIVAS</strong>
          </CCardHeader>
          <CCardBody>
            <p className="text-medium-emphasis small">
              Aquí se muestran todas las plantas opertativas hasta el momentos.
            </p>
            <DocsExample href="components/placeholder">
              <div className="d-flex justify-content-around p-3">
                <CCard style={{ width: '18rem' }}>
                  ...
                  <CCardBody>
                    <CCardTitle>EPT 1</CCardTitle>
                    <CCardText>
                      Aquí puedes ver todas las variables opertativas de la planta EPT 1.
                    </CCardText>
                    <CButton href="#/Charts">ESTADO</CButton>
                  </CCardBody>
                </CCard>
                <CCard style={{ width: '18rem' }}>
                  <CCardImage orientation="top" src={AngularImg} />
                  <CCardBody>
                    <CCardTitle>MUSCAR</CCardTitle>
                    <CCardText>
                      Aquí puedes ver todas las variables opertativas de la planta MUSCAR.
                    </CCardText>
                    <CButton href="#/Charts">ESTADO</CButton>
                  </CCardBody>
                </CCard>
                <CCard style={{ width: '18rem' }}>
                  ...
                  <CCardBody>
                    <CCardTitle>EL SALTO</CCardTitle>
                    <CCardText>
                      Aquí puedes ver todas las variables opertativas de la planta El SALTO.
                    </CCardText>
                    <CButton href="#/Charts">ESTADO</CButton>
                  </CCardBody>
                </CCard>
